...
xst -ifn xst.scr
move system_clock_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\system_clock_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc system_clock_mmcm_exdes.ucf system_clock_mmcm_exdes

echo 'Running map'
map -timing -pr b system_clock_mmcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm system_clock_mmcm_exdes -w routed.ncd routed.vhd
cd ..
